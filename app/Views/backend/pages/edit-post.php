            ...
            <div class="card card-box mb-2">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title"  value="<?= $post->title ?>" placeholder="Introduce el titulo de la publicación">
            ...
            <div class="card card-box mb-2">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Introduce la pubicion meta palabras clave." value="<?= $post->meta_keywords ?>" name="meta_keywords">
                    </div>
                    <div class="form-group">
                        <label for=""><b>Descripción de la pubicación</b></label>
                        <textarea name="meta_description" cols="30" rows="10" class="form-control"  placeholder="Descripción......."><?= $post->meta_description ?></textarea>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card card-box mb-2">
                <div class="card-body">
                    ...
                    <div class="d-block mb-3" style="max-width: 250px;">
                        <img src="/img/posts/resized_<?= $post->featured_image ?>" alt="" class="img-thumbnail" id="image-previewer" data-ijabo-default-img="/img/posts/resized_<?= $post->featured_image ?>">
                    </div>
                    <div class="form-group">
                        <label for=""><b>Tags</b></label>
                        <input type="text" name="tags" class="form-control" placeholder="Inroduce el tags" value="<?= $post->tags ?>" data-role="tagsinput">
