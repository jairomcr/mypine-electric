    ...
    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
        <div class="pd-20 card-box height-100-p">
            <div class="profile-photo">
                ...
                <img src="<?= get_user()->picture == null ? '/img/user.jpg' : '/img/'.get_user()->picture ?>" alt=""
            ...
            <div class="profile-tab height-100-p">
                <div class="tab height-100-p">
                    <ul class="nav nav-tabs customtab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#details_personal" role="tab">Detalles
                                personales</a>
                        </li>
                        <li class="nav-item">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control"
                                                    placeholder="Nombre...." value="<?= get_user()->name ?>">
...
$('#user_profile_file').ijaboCropTool({
    ...
    onSuccess: function(message, element, status) {
        ...
        if (status == 1) {
            ...
            swal({
                text: 'Se actualizado la foto de perfil',
                type: 'success',
                showConfirmButton: false,
                timer: 1500,
            });
        ...
        success: function(response) {
            ...
            if ($.isEmptyObject(response.error)) {
                if (response.status == 1) {
                    ...
                    //toastr.success(response.msg);
                    swal({
                        text: 'Has cambiado la contrañse',
                        type: 'success',
                        showConfirmButton: false,
                        timer: 1500,
                    });
